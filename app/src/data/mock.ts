...
export const calendarEvents = [
  { id: '1', title: 'Kardiologie', date: '2024-01-10', time: '14:00', category: 'medical' as const, parentId: 'mama' as const },
  { id: '2', title: 'Sociální šetření', date: '2024-01-12', time: '10:00', category: 'admin' as const, parentId: 'mama' as const },
  { id: '3', title: 'Neurolog', date: '2024-01-14', time: '09:30', category: 'medical' as const, parentId: 'tata' as const },
  { id: '4', title: 'Vyzvednout léky', date: '2024-01-10', time: '', category: 'medical' as const, parentId: 'mama' as const },
  { id: '5', title: 'Oprava zábradlí', date: '2024-01-13', time: '15:00', category: 'operational' as const, parentId: 'tata' as const },
  { id: '6', title: 'Kontrola u praktika', date: '2024-01-15', time: '11:00', category: 'medical' as const, parentId: 'mama' as const },
  { id: '7', title: 'Podání formuláře ZTP', date: '2024-01-15', time: '', category: 'admin' as const, parentId: 'tata' as const },
];
...
export const medicationSchedule: MedicationScheduleEntry[] = [
  // Mama – 4 entries
  {
    ...
    scheduledTime: '08:00',
    status: 'taken',
    confirmedAt: '2024-01-10T08:05:00',
  ...
  // Tata – 3 entries
  {
    ...
    scheduledTime: '08:00',
    status: 'taken',
    confirmedAt: '2024-01-10T08:12:00',
  ...
  },
  {
    ...
    scheduledTime: '08:00',
    status: 'taken',
    confirmedAt: '2024-01-10T08:15:00',
    confirmedBy: 'Petr Novák',
  },
  {
    id: 'ms-7',
...
export const complianceWeek: ComplianceDay[] = [
  ...
  },
  {
    date: '2024-01-08',
    entries: [
      { id: 'cw-2-1', medicationId: '1', medicationName: 'Metformin', dosage: '500 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-08T08:30:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-2-2', medicationId: '2', medicationName: 'Ramipril', dosage: '5 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-08T08:30:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-2-3', medicationId: '3', medicationName: 'Calcium + D3', dosage: '1000 mg', parentId: 'mama', scheduledTime: '12:00', status: 'missed' },
      { id: 'cw-2-4', medicationId: '4', medicationName: 'Warfarin', dosage: '3 mg', parentId: 'mama', scheduledTime: '20:00', status: 'taken', confirmedAt: '2024-01-08T20:15:00', confirmedBy: 'Petr Novák' },
    ],
  },
  {
    date: '2024-01-08',
    entries: [
      { id: 'cw-3-1', medicationId: '1', medicationName: 'Metformin', dosage: '500 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-08T08:05:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-3-2', medicationId: '2', medicationName: 'Ramipril', dosage: '5 mg', parentId: 'mama', scheduledTime: '08:00', status: 'missed' },
      { id: 'cw-3-3', medicationId: '3', medicationName: 'Calcium + D3', dosage: '1000 mg', parentId: 'mama', scheduledTime: '12:00', status: 'taken', confirmedAt: '2024-01-08T12:10:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-3-4', medicationId: '4', medicationName: 'Warfarin', dosage: '3 mg', parentId: 'mama', scheduledTime: '20:00', status: 'taken', confirmedAt: '2024-01-08T20:00:00', confirmedBy: 'Marie Nováková' },
    ],
  },
  {
    date: '2024-01-08',
    entries: [
      { id: 'cw-4-1', medicationId: '1', medicationName: 'Metformin', dosage: '500 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-08T08:20:00', confirmedBy: 'Petr Novák' },
      { id: 'cw-4-2', medicationId: '2', medicationName: 'Ramipril', dosage: '5 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-08T08:20:00', confirmedBy: 'Petr Novák' },
      { id: 'cw-4-3', medicationId: '3', medicationName: 'Calcium + D3', dosage: '1000 mg', parentId: 'mama', scheduledTime: '12:00', status: 'taken', confirmedAt: '2024-01-08T12:45:00', confirmedBy: 'Marie Nováková' },
  ...
  },
  {
    date: '2024-01-09',
    entries: [
      { id: 'cw-5-1', medicationId: '1', medicationName: 'Metformin', dosage: '500 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-09T08:00:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-5-2', medicationId: '2', medicationName: 'Ramipril', dosage: '5 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-09T08:00:00', confirmedBy: 'Marie Nováková' },
      { id: 'cw-5-3', medicationId: '3', medicationName: 'Calcium + D3', dosage: '1000 mg', parentId: 'mama', scheduledTime: '12:00', status: 'missed' },
      { id: 'cw-5-4', medicationId: '4', medicationName: 'Warfarin', dosage: '3 mg', parentId: 'mama', scheduledTime: '20:00', status: 'taken', confirmedAt: '2024-01-09T20:30:00', confirmedBy: 'Vladimír Novák' },
    ],
  },
  {
    date: '2024-01-10',
    entries: [
      { id: 'cw-6-1', medicationId: '1', medicationName: 'Metformin', dosage: '500 mg', parentId: 'mama', scheduledTime: '08:00', status: 'taken', confirmedAt: '2024-01-10T08:05:00', confirmedBy: 'Marie Nováková' },
...
export const chatThreads: ChatThread[] = [
  {
    ...
    lastActivity: '2024-01-10T14:45:00',
    messages: [
      {
        id: 'msg-1-1',
        threadId: 'thread-1',
...
export const calendarSources: CalendarSource[] = [
  {
    ...
    connected: true,
    syncStatus: 'synced',
    lastSynced: '2024-01-10T06:00:00',
  },
  {
    id: 'cal-apple',
    provider: 'apple',
...
export const monthlyReports: MonthlyReport[] = [
  {
    ...
    parentId: 'mama',
    complianceRate: 82,
    generatedAt: '2024-01-15T00:05:00',
    sections: {
      compliance: {
        taken: 140,
        missed: 30,
      ...
      visits: [
        ...
        { date: '2024-01-12', doctor: 'MUDr. Benešová (endokrinolog)' },
      ],
      familyActivity: [
